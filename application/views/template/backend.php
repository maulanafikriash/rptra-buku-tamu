...
<!--================================HEADER================================-->
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?= ucwords($this->session->userdata('user_username'))?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?= ucwords($this->session->userdata('user_nama'))?>
                  <small><?php echo "Terdaftar : " .$this->session->userdata('user_terdaftar')?></small>
                </p>
              </li>
              <!-- Menu Footer-->
  ...
  <footer class="main-footer">
    ...
    <span class="fa fa-envelope"></span> RPTRA <strong><a href="#">Jakarta Timur</a></strong>
  </footer>
</div>
<!-- ./wrapper -->
<!--=============================FOOTER====================================-->

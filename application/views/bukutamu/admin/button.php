<div class="btn-group">
	...
	<a href="javascript:void(0)"   id="<?=$row->bukutamu_id?>" url="<?= base_url($global->url.'edit_tamu')?>" class="edit btn btn-flat btn-xs btn-info <?= $global->edit!=true ? 'hide':'' ?>"><span class="fa fa-pencil"></span></a>

<div class="row">
	<div class="col-sm-12 animated bounceInRight">
		<div class="box box-warning">
			...
			<div class="box-body">
				<form id="formadd" method="POST" action="javascript:void(0)" url="<?= base_url($global->url.'edit_tamu')?>"  enctype="multipart/form-data">
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								<input type="hidden" name="id" value="<?= $data->bukutamu_id?>" class="form-control"></input>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="radio" name="bukutamu_jeniskelamin" value="Laki-laki" checked> Laki-laki
								<input type="radio" name="bukutamu_jeniskelamin" value="Perempuan"> Perempuan
							</div>
							<div class="form-group">
